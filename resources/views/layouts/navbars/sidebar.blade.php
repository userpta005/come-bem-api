<div class="sidebar">
    <div class="sidebar-wrapper">
        ...
        <ul class="nav">
            ...
            @endcan
            @canany(['leads_view', 'tenants_view', 'stores_view', 'clients_view', 'sections_view',
            'payment-methods_view', 'measurement-units_view', 'products_view', 'cities_view', 'states_view',
            'ncms_view'])
            <li>
                ...
                <div class="collapse" id="register" style="">
                    <ul class="nav pl-4">
                        ...
                        <li>
                            <a data-toggle="collapse" href="#people" aria-expanded="false" class="collapsed">
                                <i class="fas fa-users"></i>
                                <span class="nav-link-text">Pessoas</span>
                                <b class="caret mt-1"></b>
                            </a>

                            <div class="collapse" id="people" style="">
                                <ul class="nav pl-4">
                                    @can('leads_view')
                                    <li>
                        ...
                        <li>
                            <a data-toggle="collapse" href="#operational" aria-expanded="false" class="collapsed">
                                <i class="fas fa-clipboard-list"></i>
                                <span class="nav-link-text">Operacionais</span>
                                <b class="caret mt-1"></b>
                            </a>

                            <div class="collapse" id="operational" style="">
                                <ul class="nav pl-4">
                                    @can('products_view')
                                    <li>
            ...
            <li>
                <a data-toggle="collapse" href="#collapseSales" aria-expanded="false" class="collapsed">
                    <i class="fas fa-money-bill"></i>
                    <span class="nav-link-text">Vendas</span>
                    <b class="caret mt-1"></b>
                </a>
                <div class="collapse" id="collapseSales" style="">
                    <ul class="nav pl-4">
                        @canany(['cashiers_view', 'open-cashiers_view', 'cash-movements_view'])
                        <li>
                            ...
                            <div class="collapse" id="cashier" style="">
                                <ul class="nav pl-4">
                                    @can('cashiers_view')
                                    <li>
                                    ...
                                    <li>
                                        <a href="{{ route('open-cashiers.index') }}">
                                            <i class="fas fa-check"></i>
                                            <p>Abertura/<br />Fechamento</p>
                                        </a>
                                    </li>
                                    @endcan
            ...
            <li>
                <a data-toggle="collapse" href="#collapseEstoque" aria-expanded="false" class="collapsed">
                    <i class="fas fa-cubes"></i>
                    <span class="nav-link-text">Estoque</span>
                    <b class="caret mt-1"></b>
                </a>

                <div class="collapse" id="collapseEstoque" style="">
                    <ul class="nav pl-4">
                ...
                <div class="collapse" id="collapseFiance" style="">
                    <ul class="nav pl-4">
                        ...
                        <li>
                            ...
                            <div class="collapse" id="general1" style="">
                                <ul class="nav pl-4">
            ...
            <li>
                <a data-toggle="collapse" href="#management" aria-expanded="false" class="collapsed">
                    <i class="fas fa-users-cog"></i>
                    <span class="nav-link-text">Gerenciamento</span>
                    <b class="caret mt-1"></b>
                </a>

                <div class="collapse" id="management" style="">
                    <ul class="nav pl-4">
                        @can('users_view')
                        <li>
