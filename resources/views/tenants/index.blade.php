        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <x-select-ajax name="search" label="Nome Completo/Razão Social/CPF/CNPJ" route="/api/v1/people"
                                prop="info" />
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-12 text-left">
                            <p style="font-size:15px;"><b>Legenda:</b>
                                <span style="margin-right: 10px;">
                                    <span class="dot" style="background-color:#008000;"></span>
                                    Habilidade
                                </span>
                                <span style="margin-right: 10px;">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <form action="{{ route('tenants.destroy', $item->id) }}" method="post"
                                                        ...
                                                        @endcan
                                                        @can('tenants_edit')
                                                            <a class="dropdown-item btn-modal-authorization"
                                                                data-id="{{ $item->id }}"
                                                                href="#">Solicitar
                                                                Autorização</a>
                                                        @endcan
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="authorizationModalLabel">Solicitando Autorização</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" name="tenant" id="inp-tenant">
                        <label for="code">Link de Solicitação</label>
                        <input type="text" name="code" id="inp-code" class="form-control" readonly>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                    <button type="button" class="btn btn-primary btn-authorization">Solicitar</button>
                </div>
            </div>
        </div>
    </div>
...
@push('js')
    <script>
        $(document).ready(function(){
            $('.btn-modal-authorization').on('click', function(){
                var id = $(this).data('id')
                $('#inp-tenant').val(id)
        ...
        $('.btn-authorization').on('click', function(){
            $.get(getUrl() + '/api/v1/pagseguro/authorization?tenant='+$('#inp-tenant').val())
            .done(function(response) {
                $('#inp-code').val(response.data.url)
            })
            .fail(function(error) {
                swal(
                    "Atenção",
