                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-lg-8 mx-auto">
                                    ...
                                    <center>
                                        <img src="{{ asset('images/logoDixAzul.png') }}" alt="Logo"
                                            class="img-fluid mb-5" width="250px">
                                    </center>
                                    ...
                                    <form class="form" method="post" action="{{ route('login') }}">
                                        ...
                                        <button
                                            class="btn btn-lg btn-block btn-login text-white text-uppercase font-weight-bold mb-2"
