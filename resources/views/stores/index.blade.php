    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-5">
                        {!!Form::text('search','Nome Completo/Razão Social/CPF/CNPJ')!!}
                    </div>
                    <div class="col-md-3">
                ...
                <table class="table table-striped" id="">
                    <thead class="text-primary">
                        <th>Nome Completo/Razão Social/CPF/CNPJ</th>
                        <th>Contratante</th>
                        <th>Status</th>
                        <th>Ações</th>
                    </thead>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <form action="{{ route('stores.destroy', $item->id) }}" method="post"
                                            ...
                                            @endcan
                                            @can('stores_edit')
                                            <a class="dropdown-item" href="{{ route('stores.edit', $item) }}">Editar</a>
                                            @endcan
                                            @can('stores_delete')
