            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 d-flex align-items-center">
                        ...
                        <a id="clear-filter" style="font-size: 9px;" class="btn btn-sm btn-danger" href="{{ route('financial-movements.index') }}">
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <form action="{{ route('financial-movements.destroy', $item->id) }}" method="post" id="form-{{ $item->id }}">
                                                @csrf
                                                @method('delete')
                                                @can('financial-movements_view')
                                                <a class="dropdown-item" href="{{ route('financial-movements.show', $item) }}">Visualizar</a>
                                                @endcan
                                                @can('financial-movements_edit')
                                                <a class="dropdown-item" href="{{ route('financial-movements.edit', $item) }}">Editar</a>
                                                @endcan
                                                @can('financial-movements_delete')
