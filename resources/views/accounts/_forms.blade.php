<div class="row">
  <div class="col-md-3">
    {!! Form::text('balance', 'Saldo')->attrs(['class' => 'money'])->value(!empty($item->balance) ? floatToMoney($item->balance) : null)->readonly(!empty($item))->required() !!}
  </div>
  <div class="col-md-3">
    {!! Form::text('daily_limit', 'Limite Diário')->attrs(['class' => 'money'])->value(!empty($item->daily_limit) ? floatToMoney($item->daily_limit) : null)->readonly(!empty($item))->required() !!}
  </div>
  <div class="col-md-3">
