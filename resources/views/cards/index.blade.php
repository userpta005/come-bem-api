          ...
          <div class="row">
            ...
            @can('cards_create')
              <div class="col-4 text-right">
                ...
                <a href="{{ route('dependents.cards.create', ['dependent' => $dependent]) }}"
                    ...
                    <td class="text-right">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                          <form action="{{ route('dependents.cards.destroy', ['dependent' => $dependent, $item]) }}"
                            method="post"
                            id="form-{{ $item->id }}">
                            @csrf
                            @method('delete')
                            @can('cards_view')
                              <a class="dropdown-item"
                                href="{{ route('dependents.cards.show', ['dependent' => $dependent, $item]) }}">Visualizar</a>
                            @endcan
                            @can('cards_edit')
                              <a class="dropdown-item"
                                href="{{ route('dependents.cards.edit', ['dependent' => $dependent, $item]) }}">Editar</a>
                            @endcan
                            @can('cards_delete')
                              <button type="button"
